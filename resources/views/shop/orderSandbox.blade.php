        ...
        <table border="1" class="table">
            ...
            <tr class="total">
                <td colspan="5">
                    ...
                    <input type="hidden" name="notify_url" value="http://dev2.kebrok.com/app/Http/Controllers/OrdersController.php">
                    

                    {!! Html::link('shop', 'Continue Shopping', array('class'=>'tertiary-btn')) !!}
                   
                         <input type="submit" value="Test Payment WITH PAYPAL" class="secondary-cart-btn">
